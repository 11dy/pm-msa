...
import com.dy.dyauth.oauth2.userinfo.NaverUserInfo;
...
public class NaverOAuth2Client implements OAuth2Client {
    ...
    public String generateAuthorizationUrl(String state) {
        OAuth2Properties.ProviderConfig config = oAuth2Properties.getProvider(OAuth2Provider.NAVER);
