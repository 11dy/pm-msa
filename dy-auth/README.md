...
| GET | `/api/auth/oauth2/callback/{provider}` | 소셜 로그인 콜백 (프론트엔드로 리다이렉트) | X |
...
```
dy-web (3000)              Gateway (8080)              dy-auth (8081)              Google
    │                           │                           │                         │
    ...
    │                           │                           │ ───────────────────────>│
    │                           │                           │                         │
    │  302 Redirect to http://localhost:3000/oauth2/callback#access_token=...        │
    │ <─────────────────────────────────────────────────────│                         │
    │                           │                           │                         │
    │  토큰 저장 후 /dashboard로 이동                        │                         │
    │                           │                           │                         │
```
